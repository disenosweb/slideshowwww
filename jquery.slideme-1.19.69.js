(function ($) {
    ...
    var calculate = {
        ...
        height: function (target) {
            return $(target).data('height') * $('.slideme', target).eq(0).width() / $(target).data('width');
        },
    ...
    var animate = {
        playTo: function (target, index, direction) {
            ...
            if ($(target).data('transition') == "fade") {
            ...
            } else if ($(target).data('transition') == "page") {
    ...
    var comands = {
        ...
        onEndSlide: function (target, index) {
            ...
            if ($(target).data('autoslide') && $(target).data('autoslideHoverStop') && !$(target).data('pause') || $(target).data('autoslide') && !$(target).data('autoslideHoverStop')) {
